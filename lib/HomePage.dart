...
// Inside your _HomePageState class
  ...
  List<Map<String, dynamic>> categoryData = [
    ...
    ...generateCategoryData(name: 'Trending Visits in Nation', apiEndpoint: 'api/stories/best/location/${CountryName}'),
    ...generateCategoryData(name: 'International Trending', apiEndpoint: 'api/stories/other/exclude-country/${CountryName}'),
    ...
    ...generateCategoryData(specificName: 'Local Fashion for you !',name: 'Local Stores Near you', apiEndpoint: 'api/nearby-places/Fashion'),
                      ...
                      children: [
                        Container(height:450,
                          ...
                          child: AutoScrollImages(
                            ...
                            imageUrls: [
                              'http://173.212.193.109:8080/appStories/homeone.webp',
                              'http://173.212.193.109:8080/appStories/hometwo.webp',
                              'http://173.212.193.109:8080/appStories/homethree.webp',
                              'http://173.212.193.109:8080/appStories/homefour.webp',
                              'http://173.212.193.109:8080/appStories/homefive.webp',
