...
// import '../../VideoCalling/CallingScreen2.dart';
// import '../../VideoCalling/SignallingService.dart';
// import 'Uploader.dart';
//
// void main() {
//   runApp(ChatsPage(
//     userId: '652a31f77ff9b6023a14838a',
//     state: 'user',
//     meetId: '65844f69318c03e09ec1c5e0',
//   ));
// }
//
...
//   bool pageVisitor =
//   true; // true means person coming to this page is user while in else condition its helper
...
//       MaterialPageRoute(
//         builder: (context) =>
//             ChatsPage(userId: widget.userId!, state: 'user', meetId: meetId),
//       ),
//     );
//   }
//
//   Future<void> createUpdateLocalUserPings(
//       String meetId, String meetStatus) async {
...
//       } else {
//         print(
//             "Failed to create/update meet. Status code: ${response.statusCode}");
//         throw Exception("Failed to save meet");
//       }
//     } catch (e) {
//       print("Error: $e");
...
//   }
//
//   Future<void> createUpdateLocalHelperPings(
//       String meetId, String meetStatus) async {
...
//       } else {
//         print(
//             "Failed to send request message to helpers. Status code: ${response.statusCode}");
...
//               responseData['paymentStatus'] == 'initiated') {
...
//   }
//
//   Future<void> updateMeetingChats(
//       String meetId, List<String> meetDetails) async {
//     try {
//       final String serverUrl =
//           Constant().serverUrl; // Replace with your server's URL
...
//       final http.Response response = await http.patch(
//         Uri.parse(
//             '$serverUrl/storeLocalMeetingConversation'), // Adjust the endpoint as needed
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//         Constant().serverUrl; // Replace with your server's URL
//     final url = Uri.parse(
//         '$serverUrl/getLocalUserPingsStatus/${widget.userId}/${widget.meetId}'); // Replace with your backend URL
...
//       else if (data['user'] == 'helper') receiver.add(data['message']);
//     });
...
//         Constant().serverUrl; // Replace with your server's URL
//     final url = Uri.parse(
//         '$serverUrl/userStoredData/${widget.userId}'); // Replace with your backend URL
//     final http.Response response = await http.get(url);
//
//     if (response.statusCode == 200) {
//       final data = json.decode(response.body);
...
//         Constant().serverUrl; // Replace with your server's URL
//     final url = Uri.parse(
//         '$serverUrl/userStoredData/${userId}'); // Replace with your backend URL
//     final http.Response response = await http.get(url);
//
//     if (response.statusCode == 200) {
//       final data = json.decode(response.body);
...
//         helperId = userId;
//         helperLatitude =
//         data['latitude'] == null ? '25.4622095' : data['latitude'];
//         helperLongitude =
//         data['longitude'] == null ? '78.6419707' : data['longitude'];
...
//   }
//
//   Future<void> updateLocalUserPings(
//       String userId, String meetId, String meetStatus) async {
//     final String serverUrl =
//         Constant().serverUrl; // Replace with your server's URL
...
//         socket.emit('message',
//             {'message': widget.userId, 'user1': 'admin-user-1', 'user2': ''});
//         setState(() {});
//       } else {}
//     }
//   }
...
//           socket.emit(
//               'message', {'message': message, 'user1': 'user', 'user2': ''});
//         } else {
//           updateMeetingChats(widget.meetId!, [message, 'helper']);
//           socket.emit(
//               'message', {'message': message, 'user1': '', 'user2': 'helper'});
//         }
//         _controller.clear();
