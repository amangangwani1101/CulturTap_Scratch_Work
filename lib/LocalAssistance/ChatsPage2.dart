...
//   String userId;
//   String ? state,meetId,helperId,meetStatus;
//
//   ChatsPage({required this.userId,this.state,this.meetId,this.helperId,this.meetStatus});
//   @override
...
//                                       mainAxisAlignment: MainAxisAlignment.start,
//                                       children: [
//                                         Text('finding helping hands',style: Theme.of(context).textTheme.subtitle1,),
//                                         SizedBox(width : 5),
//                                         LoadingDotAnimation(),
//                                       ],
//                                     ),
...
//                       children: [
//
//                         (widget.state=='user' && meetStatus=='accept') ? Column(
//                           children: [
//
//                             GestureDetector(
//                               onTap: ()async{
...
//                                   //   userToken,
//                                   //   'Payment Successfull',
//                                   //   'payment Recieved Successfully','Connect With Your Saviour Via Text, Voice Call, Video Call',
...
//                         ) : Column(),
//
//                         (meetStatus=='cancel' || meetStatus=='close') ? Center(
//                           child: Container(
//                             height : 63,
//
...
//
//
//                         // (meetStatus == 'cancel' || meetStatus =='close') ? Container()
//                         //     : Container(
//                         //   height: 75,
//                         //   child: Row(
//                         //     mainAxisAlignment: MainAxisAlignment.start,
