...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const OtpFiller(),
    );
  }
}

class OtpFiller extends StatefulWidget {
  const OtpFiller({Key? key}) : super(key: key);

  @override
  State<OtpFiller> createState() => _OtpFillerState();
}

class _OtpFillerState extends State<OtpFiller> {
  String _code="";
