...
const getBestStories = require('./routes/getBestStories.js');
const getBestCategoryStory = require('./routes/getBestCategoryStory.js');
const getBestCategoryGenreStory = require('./routes/getBestCategoryGenreStory.js');
const getStoriesByBusinessCategory = require('./routes/getStoriesByBusinessCategory.js');

const getBestGenreStory = require('./routes/getBestGenreStory.js');
const searchStories = require('./routes/searchStories.js');

const suggestionsRouter = require('./routes/SearchEngine/suggestions.js');

const userRequestRoutes = require('./routes/userRequestRoutes.js');
// required db
...
const NotificationHandler = require('./routes/NotificationHandler.js');
const {localAssistantHandler1,localAssistantHandler2,localAssistantHandler3,localAssistantHandler4} =  require('./routes/ScheduleHandler.js');
...
app.use('/api', getBestStories);
app.use('/api', getBestCategoryStory);
app.use('/api', getBestCategoryGenreStory);
app.use('/api', getBestGenreStory);
app.use('/api/search', searchStories);
app.use('/api', getStoriesByBusinessCategory);
...
// automatic handler of local assistant
localAssistantHandler1();
localAssistantHandler2();
localAssistantHandler3();
localAssistantHandler4();
...
io.on("connection", (socket) => {
  ...
  console.log(socket.user, "Video Calling Connected");
